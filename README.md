...
flowchart TD
    %% Styling
    classDef ui fill:#4f46e5,stroke:#312e81,stroke-width:2px,color:#fff,rx:8px,ry:8px;
    classDef ext fill:#be185d,stroke:#831843,stroke-width:2px,color:#fff,rx:8px,ry:8px;
    classDef agent fill:#0284c7,stroke:#0c4a6e,stroke-width:2px,color:#fff,rx:8px,ry:8px;
    classDef util fill:#059669,stroke:#064e3b,stroke-width:2px,color:#fff,rx:8px,ry:8px;
